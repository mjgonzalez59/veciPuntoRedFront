...
type ShowComponentKeys = 'smartphone' | 'description' | 'receipt' | 'rss_feed' | 'location_on' | 'comment';
...
export class TransactionComponent implements OnInit {
  ...
  showComponent: { [key in ShowComponentKeys]: boolean } = TransactionConstants.showComponent;
